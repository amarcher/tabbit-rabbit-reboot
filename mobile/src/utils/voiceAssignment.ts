...
/** BYOK: Direct Anthropic API call from mobile (key stored in expo-secure-store) */
...
export async function parseVoiceAssignmentFree(
  ...
  const response = await fetch('https://tabbitrabbit.com/api/parse-voice-assignment', {
    method: 'POST',
